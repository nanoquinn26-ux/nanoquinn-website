      ...
      <div className="bg-foreground text-background pt-32 pb-20 sm:pb-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-balance leading-tight mb-6">
            ...
            <span className="bg-gradient-to-r from-[#5EEAD4] via-[#14B8A6] to-[#1FA855] bg-clip-text text-transparent">NanoQuinn</span>
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-28">
        <div className="flex flex-col gap-12">
          {leaders.map((leader, idx) => (
            <div
              key={leader.name}
              className="bg-background border border-border rounded-3xl overflow-hidden hover:border-[#1FA855]/60 hover:shadow-lg transition-all duration-200"
            >
              {/* Top index strip */}
              <div className="bg-foreground px-8 py-3 flex items-center gap-3">
                <span className="text-sm font-black uppercase tracking-widest" style={{ color: "#1FA855" }}>
              ...
              <div className="flex flex-col lg:flex-row">
                ...
                <div className="lg:w-80 shrink-0 bg-muted flex flex-col items-center justify-start p-6 gap-6 border-b lg:border-b-0 lg:border-r border-border">
                  ...
                  {leader.photo ? (
                    ...
                    <div
                      ...
                      style={{ borderColor: "#1FA855", backgroundColor: "#1FA85510" }}
                    >
                      <div className="w-16 h-16 rounded-full mb-3" style={{ backgroundColor: "#1FA85530" }} />
                      <span className="text-xs font-semibold uppercase tracking-widest" style={{ color: "#1FA855" }}>
                        Photo
                      </span>
                    </div>
                  )}
                ...
                <div className="flex-1 px-6 sm:px-8 py-8 flex flex-col gap-4">
                    ...
                    <p key={i} className="text-muted-foreground leading-relaxed">
                      {leader.name === "Rajiv Sanghvi" && i === 0 ? (
                        <>
                          ...
                          <span className="font-black text-foreground" style={{ color: "#1FA855" }}>
                  ...
                  {leader.statements.length > 0 && (
                    <div className="my-2 border-l-4 pl-5 flex flex-col gap-2" style={{ borderColor: "#1FA855" }}>
                  ...
                  {leader.skills && (
                    <p className="text-sm font-bold mt-2 pt-4 border-t border-border" style={{ color: "#1FA855" }}>
                      {leader.skills}
                    </p>
                  )}
                </div>
