        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white mb-6 text-balance">
              ...
              <span className="text-[#111111]">Protect Your Assets</span>{" "}
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              <a
                key={item.label}
                href={item.href}
                className="flex flex-col items-center gap-4 p-8 bg-white/5 border border-white/10 rounded-3xl hover:bg-white/10 hover:border-[#111111]/40 transition-all group"
              >
                <div className="w-14 h-14 rounded-2xl bg-[#111111]/10 border border-[#111111]/30 flex items-center justify-center group-hover:bg-[#111111]/20 transition-colors">
          ...
          <div className="mt-16 text-center">
            <a
              ...
              className="inline-flex items-center gap-3 px-10 py-5 rounded-full bg-[#3A3A3A] text-white text-lg font-semibold hover:bg-[#1ebe5d] transition-colors shadow-xl"
            >
