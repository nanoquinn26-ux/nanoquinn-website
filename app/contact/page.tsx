        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="mt-16 text-center">
            <a
              ...
              className="inline-flex items-center gap-3 px-10 py-5 rounded-full bg-[#0D9488] text-white text-lg font-semibold hover:bg-[#1ebe5d] transition-colors shadow-xl"
            >
