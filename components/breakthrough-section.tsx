      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-12 sm:gap-16 lg:gap-20 items-center">
          ...
          <div className="w-full text-center py-4">
            <h2 className="text-3xl sm:text-5xl lg:text-7xl font-black tracking-tight text-balance leading-tight uppercase italic" style={{ color: "#1FA855" }}>
          ...
          <div className="text-center max-w-4xl w-full">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-8 sm:mb-10">
              {benefits.map((item) => (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-[#1FA855]/10 flex items-center justify-center shrink-0">
