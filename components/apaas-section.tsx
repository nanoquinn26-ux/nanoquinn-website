      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16 sm:mb-24">
          <div className="bg-gradient-to-br from-[#0B2545] via-[#0B2545] to-[#06182E] rounded-3xl p-10 sm:p-16 lg:p-20">
            ...
            <p className="text-xl sm:text-2xl leading-relaxed font-medium">
              ...
              <span className="bg-gradient-to-r from-[#5EEAD4] via-[#14B8A6] to-[#1FA855] bg-clip-text text-transparent font-bold">
        ...
        <div className="max-w-5xl mx-auto mb-20 sm:mb-28">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-4">
            ...
            <span className="bg-gradient-to-r from-[#5EEAD4] via-[#14B8A6] to-[#1FA855] bg-clip-text text-transparent">Biggest Pain Points</span>
          </h2>
        ...
        <div className="max-w-5xl mx-auto mb-20 sm:mb-28">
          <div className="bg-muted rounded-3xl p-8 sm:p-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-10">
              <span className="bg-gradient-to-r from-[#5EEAD4] via-[#14B8A6] to-[#1FA855] bg-clip-text text-transparent">Massive Savings</span>{" "}
        ...
        <div className="max-w-5xl mx-auto mb-20 sm:mb-28">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6">
            ...
            <span className="bg-gradient-to-r from-[#5EEAD4] via-[#14B8A6] to-[#1FA855] bg-clip-text text-transparent">Temporary Maintenance</span>{" "}
            <span className="text-foreground">To</span>{" "}
            <span className="bg-gradient-to-r from-[#5EEAD4] via-[#14B8A6] to-[#1FA855] bg-clip-text text-transparent">Long-Term Preservation</span>
          </h2>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-[#0B2545] to-[#06182E] text-white rounded-3xl p-8 sm:p-12 lg:p-16 text-center">
            ...
            <p className="text-xl sm:text-2xl font-bold">
              <span className="bg-gradient-to-r from-[#5EEAD4] via-[#14B8A6] to-[#1FA855] bg-clip-text text-transparent">
