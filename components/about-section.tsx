    ...
    <section className="bg-background">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight text-foreground mb-6 leading-tight">
              ...
              <span className="text-[#111111] italic">&ldquo;Only Me&rdquo; Thinking</span>
            </h2>
          ...
          <div className="bg-foreground rounded-3xl p-10 lg:p-12">
            ...
            <div className="border-t border-background/20 pt-6">
              <p className="text-[#111111] font-bold text-sm uppercase tracking-widest">NanoQuinn Vision</p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {pillars.map((pillar) => (
              <div
                key={pillar.title}
                className="bg-background border border-border rounded-2xl p-8 hover:border-[#111111]/60 hover:shadow-md transition-all duration-200"
              >
                <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-5" style={{ backgroundColor: "#11111120" }}>
                  <pillar.icon className="w-6 h-6" style={{ color: "#111111" }} />
                </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 lg:py-28 text-center">
        <p className="text-3xl sm:text-4xl lg:text-5xl font-black text-foreground text-balance leading-tight max-w-4xl mx-auto">
          ...
          <span className="text-[#111111]">every surface</span>,{" "}
          <span className="text-[#111111]">every asset</span>,{" "}
          in every country.
        </p>
      </div>
