    ...
    <section className="bg-background">
      ...
      <div className="bg-foreground text-background py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black tracking-tight leading-tight text-balance mb-6">
            <span className="text-white">Build the Future of</span><br />
            <span className="text-white/60">Asset Protection</span>
          </h1>
          <p className="text-white/70 text-lg leading-relaxed max-w-2xl mx-auto">
            At NanoQuinn, we are not hiring for jobs.<br />
            We are building a team of <span className="text-white font-semibold">category creators</span>.
          </p>
          <p className="mt-4 text-white/50 text-base italic">
      ...
      <div className="py-20 px-6 border-b border-border">
        <div className="max-w-5xl mx-auto">
          ...
          <ul className="grid sm:grid-cols-2 gap-4">
            {whyItems.map((item) => (
              <li key={item} className="flex items-start gap-3 bg-muted rounded-xl p-4">
                <span className="mt-1 w-2 h-2 rounded-full bg-[#3A3A3A] shrink-0" />
          ...
          <p className="mt-8 text-foreground font-bold text-lg">
            ...
            <span className="text-[#3A3A3A]">This is industrial transformation.</span>
          </p>
        </div>
      </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
            {whoWeWant.map(({ icon: Icon, text }) => (
              <div key={text} className="bg-background border border-border rounded-2xl p-5 flex items-start gap-4 hover:border-[#3A3A3A]/60 transition-colors">
                <div className="w-9 h-9 rounded-full bg-[#3A3A3A]/10 flex items-center justify-center shrink-0">
                  <Icon className="w-4 h-4 text-[#3A3A3A]" />
                </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {whatYoullBuild.map(({ icon: Icon, text }) => (
              <div key={text} className="flex items-start gap-4 p-5 rounded-2xl border border-border hover:border-[#3A3A3A]/50 transition-colors">
                <div className="w-9 h-9 rounded-full bg-[#3A3A3A]/10 flex items-center justify-center shrink-0">
                  <Icon className="w-4 h-4 text-[#3A3A3A]" />
                </div>
                <p className="text-sm text-foreground leading-relaxed">{text}</p>
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {culturePoints.map((point) => (
              <div key={point} className="flex items-center gap-3 bg-background rounded-xl px-5 py-4 border border-border">
                <span className="w-2 h-2 rounded-full bg-[#3A3A3A] shrink-0" />
      ...
      <div className="py-24 px-6 bg-foreground text-background text-center">
        <div className="max-w-2xl mx-auto">
          <p className="text-white/50 text-sm uppercase tracking-widest mb-4">Join Us</p>
          <h2 className="text-4xl sm:text-5xl font-black mb-4 text-balance">
            <span className="text-white">Careers That</span><br />
            <span className="text-white/60">Create Categories</span>
          </h2>
