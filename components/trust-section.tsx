      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5">
          {clients.map((client) => (
            <div
              key={client.name}
              className="bg-background border border-border rounded-2xl p-4 sm:p-6 flex flex-col items-center justify-center gap-3 hover:border-[#25D366]/60 hover:shadow-md transition-all duration-200 min-h-[160px] sm:min-h-[200px] overflow-hidden"
            >
              <div className="w-full flex items-center justify-center px-2">
                ...
                />
                <div className="hidden w-12 h-12 rounded-full bg-[#25D366] items-center justify-center shrink-0">
